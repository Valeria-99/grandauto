  ...
  return (
    ...
    w-full border-r border-borderColor text-sm'>
        ...
        <div className='group relative'>
            ...
            "https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=300"} alt="" className='h-9 md:h-14 w-9 md:w-14
            rounded-full mx-auto'/>
            <input type="file" id='image' accept="image/*" hidden onChange={e=>setImage(e.target.files[0])}/>

            <div className='absolute hidden top-0 ring-0 left-0 bottom-0 bg-black/10 
        ...
        {image && (
            <button className='absolute top-0 ring-0 flex p-2 gap-1 bg-primary/10 text-primary cursor-pointer'>Save <img src={assets.check_icon} width={13} 
            alt="check_icon" onClick={updateImage}/></button>
        )}
